...
class CPPN:
    ...
    def get_output(self,body_dimension):
        ...
        # do resolution, no need. # bone_proportion = np.zeros(body_dimension)
        ...
        # do resolution, no need. # bone_proportion = ret["bone_proportion"]
        # do resolution, no need. return body, phaseoffset, bone_proportion
